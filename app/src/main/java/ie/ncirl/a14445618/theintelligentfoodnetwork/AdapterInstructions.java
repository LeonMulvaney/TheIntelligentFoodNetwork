...
public class AdapterInstructions extends BaseAdapter {
    Context context;
    ArrayList<ModelInstruction> instructionList;
    LayoutInflater inflter;

    public AdapterInstructions(Context applicationContext, ArrayList<ModelInstruction> instructionList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.adapter_instructions_layout, null);
